...
| NFR-05 | Tree cleanliness | 0 working-tree modifications of the analyzed repo at rest | `git status --porcelain` empty after every Warpline operation, asserted in CI | metrics.md guardrail; precedent regression `weft-d822a7de2d` |
